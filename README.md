...
| ポートフォリオ | フォールバック銘柄 |
|--------------|------------------|
| 攻撃型聖杯 | NVDA, META, AMZN, GOOGL, MSFT, AAPL, TSLA, AMD, AVGO, CRM（10銘柄） |
| 防御型聖杯 | SPY, AGG, GLD, TLT, EFA（5銘柄） |

フォールバックデータを使用している場合、UIにアンバー色の警告バナーを表示してユーザーに通知します。
...
| 項目 | 最適化前（1日あたり） | 最適化後（1日あたり） | 削減率 |
|------|---------------------|---------------------|--------|
| シグナル指標 | 192回 | 4回 | 98% |
| ポートフォリオ | 6,132回 | 約17回 | 99.7% |
| **合計** | **6,324回** | **約22回** | **99.7%** |
